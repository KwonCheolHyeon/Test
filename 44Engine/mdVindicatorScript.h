...
namespace md
{
	...
	class Transform;
	class RigidBody;
	class VindicatorScript : public Script
	{
	public:
	...
	public:
		...
		eVindicatorState GetZombieState() { return mState; }
		void		     SetZombieState(eVindicatorState _eState) { mState = _eState; }

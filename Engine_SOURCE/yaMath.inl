...
inline md::math::Rectangle Rectangle::Intersect(const Rectangle& ra, const Rectangle& rb) noexcept
{
...
inline md::math::Rectangle Rectangle::Union(const Rectangle& ra, const Rectangle& rb) noexcept
{
    const long righta = ra.x + ra.width;
    const long rightb = rb.x + rb.width;
...
inline float md::math::Vector3::CalculateDistance(const Vector3& v1, const Vector3& v2) noexcept
{
    float dx = v2.x - v1.x;
    float dy = v2.y - v1.y;
    float dz = v2.z - v1.z;
...
inline Vector3 md::math::Vector3::CalculateDirection(const Vector3& v1, const Vector3& v2) noexcept
{
    float dx = v2.x - v1.x;
    float dy = v2.y - v1.y;
    float dz = v2.z - v1.z;
